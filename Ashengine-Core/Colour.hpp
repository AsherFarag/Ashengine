...
struct Colour
{
	...
	Colour operator +( Colour a_RHS ) const
	{
		...
		if ( A < 1.0e-6f )
		{
			return Colour( static_cast< Channel >(255), static_cast<Channel>(255), static_cast<Channel>(255), 0 );
		}
	...
	Colour& operator +=( Colour a_RHS )
	{
		...
		if ( A < 1.0e-6f )
		{
			*this = Colour(static_cast<Channel>(255), static_cast<Channel>(255), static_cast<Channel>(255), 0);
			return *this;
		}
